...
export default function BracketMadnessCaseStudy() {
  ...
  <div className="max-w-4xl w-full bg-black/30 text-white rounded-3xl shadow-xl p-10 space-y-8">
      ...
      {/* <div className="max-w-4xl w-full bg-white rounded-3xl shadow-xl p-10 md:p-16 space-y-8"> */}
        ...
        <section className="space-y-4">
          ...
          <p className="text-lg leading-relaxed">
            The idea for Bracket Madness started with a frustrating user experience in a major bracket challenge app. The interface forced users into a rigid step-by-step flow, which made it difficult to move freely between different regions and rounds. For users who prefer a more strategic or intuitive approach — jumping between rounds, revisiting early picks, or scanning the full picture — the experience felt restrictive and disjointed.
          </p>
          <p className="text-lg leading-relaxed">
        ...
        <section className="space-y-4">
          ...
          <p className="text-lg leading-relaxed">
            Build a secure full-stack app where users can play individually or in groups, competing in a bracket-based prediction game. The platform features a custom scoring system, game results updated automatically every 10 minutes, and a dynamic user experience, while amplifying visibility for women&apos;s sports.
          </p>
        </section>
